...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="w-8 h-8 flex items-center justify-center rounded-lg text-foreground/70 hover:text-foreground hover:bg-foreground/10 transition-all duration-200"
    >
      {theme === "dark" ? (
